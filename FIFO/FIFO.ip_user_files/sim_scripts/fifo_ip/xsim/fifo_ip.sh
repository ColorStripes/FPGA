...
#
# Generated by Vivado on Tue Oct 22 20:21:18 +0800 2024
...
# Script info
echo -e "fifo_ip.sh - Script generated by export_simulation (Vivado v2017.4 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L fifo_generator_v13_2_1 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_ip xil_defaultlib.fifo_ip xil_defaultlib.glbl -log elaborate.log
}
